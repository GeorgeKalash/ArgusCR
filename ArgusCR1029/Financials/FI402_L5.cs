...
{
    public partial class FI402_L5 : ArgusRPT.BaseReport
    {
        public FI402_L5()
        {
            InitializeComponent();
        ...
        {
            SharedClasses.JsonProtocol.QryStructure<ArgusDS._1029.FI402_L5> obj = deserializeList<ArgusDS._1029.FI402_L5>();
            DataSource = obj.list;
