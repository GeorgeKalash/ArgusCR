...
namespace ArgusCR1029.Inventory
{
    public partial class IV411_L1B : ArgusRPT.BaseReport
    {
        ...
        protected override void labelsText()
        {
            ...
            siteRef_lbl.Text = labelText(4);
            ItemGroup_lbl.Text = labelText(5);
            productionLine_lbl.Text = labelText(6);
            collection_lbl.Text = labelText(7);
            pcs_lbl.Text = labelText(8);
            qty_lbl.Text = labelText(9);
            purity_lbl.Text = labelText(10);
            qtyG21_lbl.Text = labelText(11);
            avgWeight_lbl.Text = labelText(12);
            pct_lbl.Text = labelText(13);

            SubTotal_lbl.Text = labelText(14);
            grandTotal_lbl.Text = labelText(15);

            mu_lbl.Text = labelText(16);
        }
