...
namespace ArgusCR1029.Sales
{
    public partial class SA206 : ArgusRPT.BaseReport
    {
        ...
        protected override void OnBeforePrint(PrintEventArgs e)
        {
            ...
            salesPerson_param.Text = Parameters.Count > 3 ? Parameters[3].Value.ToString() : string.Empty;
            clientGrp_param.Text = Parameters.Count > 4 ? Parameters[4].Value.ToString() : string.Empty;
        ...
        protected override void labelsText()
        {
            ...
            salesPerson_lbl.Text = labelText(16);
