...
{
    public partial class SA208 : ArgusRPT.BaseReport
    {
        public SA208()
        {
            InitializeComponent();
        ...
        {
            SharedClasses.JsonProtocol.QryStructure<ArgusDS.Sales.Reports.SA208> obj = deserializeList<ArgusDS.Sales.Reports.SA208>();
            DataSource = obj.list;
